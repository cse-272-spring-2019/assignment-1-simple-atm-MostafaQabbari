...
public class login extends javax.swing.JFrame {
   ...
   int x;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Enter your 5 number of your account ");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(accountNum, javax.swing.GroupLayout.PREFERRED_SIZE, 178, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void accountNumActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_accountNumActionPerformed
      ...
      String text = accountNum.getText();
      x = Integer.parseInt(text);
         Accountsec account = new Accountsec();
        account.account(x);
        account.check();
        System.out.println(account.getvalid());
       if(account.getvalid()== true){
